-- SE REALIZO UN BACKUP DE LA BASE DE DATOS DEL PROYECTO EN EL QUE SE INCLUYÓ UNICAMENTE LAS TABLAS.
-- LAS TABLAS SON: 
-- 1. `alumnos`
-- 2. `curso`
-- 3. `log_alumnos`
...
CREATE TABLE `log_alumnos` (
  ...
  `hora` time NOT NULL,
  PRIMARY KEY (`id_log`),
  KEY `fk_log_alumnos_alumnos_idx` (`id_alumno`),
  CONSTRAINT `fk_log_alumnos_alumnos` FOREIGN KEY (`id_alumno`) REFERENCES `alumnos` (`id_alumno`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `log_alumnos` VALUES (8,20,'INSERT','root@localhost','2023-11-09','20:30:58'),(9,5,'UPDATE','root@localhost','2023-11-09','20:32:04');
/*!40000 ALTER TABLE `log_alumnos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_registros`
--
...
--
-- Dumping data for table `log_registros`
--

LOCK TABLES `log_registros` WRITE;
/*!40000 ALTER TABLE `log_registros` DISABLE KEYS */;
INSERT INTO `log_registros` VALUES (2,'registros_de_imc','BEFORE INSERT','root@localhost','2023-11-09','21:20:25'),(3,'registros_de_peso','BEFORE INSERT','root@localhost','2023-11-09','21:21:40'),(4,'registros_de_peso','BEFORE INSERT','root@localhost','2023-11-09','21:21:58'),(5,'registros_de_peso','AFTER UPDATE','root@localhost','2023-11-09','21:29:35'),(6,'registros_de_imc','AFTER UPDATE','root@localhost','2023-11-09','21:30:47');
/*!40000 ALTER TABLE `log_registros` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `registros_de_peso` VALUES (9,11,80.0,'2023-02-02'),(12,11,67.0,'2023-03-02'),(13,11,70.5,'2023-03-10'),(14,11,75.0,'2023-03-08'),(15,11,75.0,'2023-03-08');
...
-- Dump completed on 2023-11-24 11:08:03
